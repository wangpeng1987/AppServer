...
public class JSONUtils {
    ...
    public static <T> ArrayList<T> getPersons(String jsonString, Class<T> cls) {
        ...
        try {
            ...
            // {}.getType());
            Type lt = new TypeToken<List<T>>() {
            }.getType();
            list = gson.fromJson(jsonString, lt);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return list;
    ...
    public static <T> T fromJson(String json, TypeToken<T> token,
        ...
        try {
            ...
            ex.printStackTrace();
            LOG.E("JSON", json + " 无法转换为 " + token.getRawType().getName() + " 对象!" + ex.getMessage());
            return null;
        }
    }
    ...
    public static <T> T fromJson(String json, Class<T> clazz, String datePattern) {
        ...
        try {
            ...
            LOG.E("JSON", json + " 无法转换为 " + clazz.getName() + " 对象!" + ex.getMessage());
            return null;
        }
    }
    ...
    public static String toJson(Object target, Type targetType,
        ...
        try {
            ...
            LOG.E("JSON", "目标对象 " + target.getClass().getName() + " 转换 JSON 字符串时，发生异常！" + ex.getMessage());
